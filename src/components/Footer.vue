...
<template>
    <footer aria-label="footer" class="py-8 bg-p-dark-grey">
        <div
            class="container flex flex-col items-center gap-y-6 lg:gap-y-0 lg:flex-row lg:gap-x-20"
            aria-label="content wrapper"
        >
            <RouterLink to="/" aria-label="home page link" role="link">
                <svg
            ...
            >
                <ul
                    ...
                    class="flex flex-col gap-y-6 lg:flex-row lg:gap-y-0 lg:gap-x-5 lg:items-center"
                >
                    <li role="listitem" aria-label="navigation link item">
                        <RouterLink
                            aria-label="about link page"
                            role="link"
                            class="transition text-p-light-grey duration-200 hover:text-p-yellow"
                            to="/about"
                            >About</RouterLink
                        >
                    </li>
                ...
                <ul
                    ...
                    class="flex justify-center gap-x-4 items-center"
                >
                    <li role="listitem" aria-label="facebook">
                        <a href="#" aria-label="facebook link" role="link">
                            <svg
                                class="social__icon"
                                ...
                                height="20px"
                            >
                                <title>Link to our facebook</title>
                                <use
                    ...
                    <li role="listitem" aria-label="twitter">
                        <a href="#" aria-label="twitter link" role="link">
                            <svg
                                ...
                                height="20px"
                            >
                                <title>Link to our twitter</title>
                                <use
                    ...
                    <li role="listitem" aria-label="instagram">
                        <a href="#" aria-label="instagram link" role="link">
                            <svg
                                class="social__icon"
                                ...
                                height="20px"
                            >
                                <title>Link to our instagram</title>
                                <use
