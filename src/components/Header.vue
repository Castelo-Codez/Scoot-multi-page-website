    ...
    <header role="banner" aria-label="header" class="py-4 bg-white relative">
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <RouterLink
                            ...
                            role="link"
                            class="transition text-p-snow duration-200 hover:text-p-yellow"
                            to="/about"
                            >About</RouterLink
                        >
                    </li>
                ...
                <PrimaryBtn
                    content="Get Scootin"
                    aria-label="Get Started With Scootin"
                />
            </nav>
            <nav
                role="navigation"
                ...
                >
                    <li role="listitem" aria-label="navigation link item">
                        <RouterLink
                            aria-label="about link page"
                            role="link"
                            class="transition text-p-dim-grey duration-200 hover:text-p-yellow"
                            to="/about"
                            >About</RouterLink
                        >
                    </li>
