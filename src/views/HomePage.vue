...
<template>
    <main role="main" aria-label="home page content">
        <section
            class="landing py-48 bg-no-repeat bg-cover relative"
            aria-label="landing section"
        >
            <div class="container" aria-label="content wrapper">
                <article
                    role="article"
                    aria-label="article scooter sharing"
                    class="text-white text-center 2xl:text-left 2xl:w-[60%]"
                >
                    <h1
                        aria-level="1"
                        role="heading"
                        class="text-[2.1rem] lg:text-[3.5rem] leading-[50px]"
                    >
                        Scooter sharing made simple
                    </h1>
                    <p
                        aria-label="about scooting"
                        class="font-lexend mt-10 z-50 2xl:relative 2xl:left-24 2xl:top-10 leading-7 2xl:w-[60%]"
                    >
                        Scoot takes the hassle out of urban mobility. Our bikes
                        are placed in convenient locations in each of our
                        cities. Use our app to locate the nearest bike, unlock
                        it with a tap, and you’re away!
                    </p>
                    <PrimaryBtn
                        content="Get Scootin"
                        class="mt-5 mx-auto 2xl:relative 2xl:left-24 2xl:top-10 block w-fit 2xl:mx-0"
                    />
                </article>
            </div>
            <div
                aria-hidden="true"
                class="pattern hidden absolute right-0 md:block top-[80%] 2xl:top-[69%]"
            >
            ...
            <div
                class="pattern absolute -left-[80%] sm:-left-[60%] md:-left-[10%] sm:top[80%] 2xl:top-[60%] 2xl:left-[48%]"
                aria-hidden="true"
            >
                <svg
            ...
            <div
                class="pattern absolute top-[60%] hidden 2xl:block"
                aria-hidden="true"
            >
        ...
        >
            ...
            >
                <ul
                    role="list"
                    aria-label="list of steps"
                    class="flex flex-col gap-y-10 lg:gap-0 lg:flex-row lg:gap-x-32"
                >
                    <li
                        role="listitem"
                        class="flex flex-col items-center text-center gap-y-6 md:flex-row md:gap-y-0 md:text-left md:gap-x-16 md:items-start lg:flex-col lg:gap-y-5"
                        aria-label="step 1"
                    >
                        <span aria-label="icon wrapper" class="relative">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="96"
                                height="96"
        ...
        <section class="features py-20 overflow-x-hidden" aria-label="features">
            <FeaturesLayout
                heading="Easy to use riding telemetry"
                para="The Scoot app is available with riding telemetry. This means it can show you your average speed, how long you've been using the scooter, your traveling distance, and many more things all in an easy to use app."
                :btn="true"
                button-content="Learn More"
                src="/info/telemetry.webp"
                :article-first="true"
            />

            <FeaturesLayout
                heading="Coming to a city near you"
                para="Scoot is available in 4 major cities so far. We’re expanding rapidly, so be sure to let us know if you want to see us in your hometown. We’re aiming to let our scooters loose on 23 cities over the coming year."
                :btn="true"
                button-content="Learn More"
                src="/info/near-you.webp"
                :article-first="false"
            />

            <FeaturesLayout
                heading="Zero hassle payments"
                para="Our payment is as easy as one two three. We accept most credit cards and debit cards. You can also link your PayPal account inside the app. Need to pay later? No worries! You can defer payment for up to a month."
                :btn="true"
                button-content="Learn More"
                src="/info/payments.webp"
                :article-first="true"
            />
        </section>
    </main>
...
section.landing {
    background-image: url("/header/main-mobile.webp");
    @media (min-width: 575.5px) {
        background-image: url("/header/main-tablet.webp");
    }
    @media (min-width: 991.5px) {
        background-image: url("/header/main-desktop.webp");
    }
}
